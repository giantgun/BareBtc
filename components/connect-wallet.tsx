    ...
    <div className="container flex items-center justify-center min-h-screen">
      <Card className="w-full max-w-md web3-card web3-card-highlight">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl bitcoin-gradient">Connect Your Wallet</CardTitle>
          <CardDescription>Connect your Stacks wallet to access the BareBtc lending platform</CardDescription>
        </CardHeader>
          ...
          <div className="flex justify-center gap-4">
            <div className="flex flex-col items-center">
              <div className="h-10 w-10 rounded-full bg-gray-100 flex items-center justify-center soft-shadow">
                <img src="/placeholder.svg?height=24&width=24" alt="Hiro Wallet" className="h-6 w-6" />
              </div>
            ...
            <div className="flex flex-col items-center">
              <div className="h-10 w-10 rounded-full bg-purple-100 flex items-center justify-center soft-shadow">
                <img src="/placeholder.svg?height=24&width=24" alt="Xverse Wallet" className="h-6 w-6" />
              </div>
            ...
            <div className="flex flex-col items-center">
              <div className="h-10 w-10 rounded-full bg-amber-100 flex items-center justify-center soft-shadow">
                <img src="/placeholder.svg?height=24&width=24" alt="Leather Wallet" className="h-6 w-6" />
              </div>
